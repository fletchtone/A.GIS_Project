...
lyr_EsriGraydark_0.setVisible(true);lyr_ChangePrices_1.setVisible(true);lyr_EsriBoundariesPlaces_2.setVisible(true);
var layersList = [lyr_EsriGraydark_0,lyr_ChangePrices_1,lyr_EsriBoundariesPlaces_2];
...
lyr_ChangePrices_1.on('precompose', function(evt) {
